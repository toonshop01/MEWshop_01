            ...
            <div class="col-lg-7 m-auto">
                ...
                <center>
                    <div class="col-lg-4" data-aos="fade-down" data-aos="700">
                        <img src="https://static.vecteezy.com/system/resources/thumbnails/009/344/493/small/x-transparent-free-png.png" class="img-fluid">
                    </div>
<h5 class="m-0">&nbsp;ปิดใช้งานชั่วคราว</h5>
                </center>
                    ...
                    if (code && code.data) {
                        ...
                        $.ajax({
                            ...
                            Swal.fire({
                                ...
                                text: 'ระบบถูกบล็อก เนื่องจาก : "Kplus - Bot Detected"'
                            }).then(function() {
                                window.location = "?page=slip";
                            });
                        });
