            ...
            <div class="container-sm m-auto p-4 pt-0">
                <div class="container-fluid p-4  bg-glass shadow-sm ">
                    ...
                    <div class="col-lg-8 m-auto">
                        <div class="row">
                            ราคาครั้งละ <?php echo number_format($wheel["price"], 2)?> เครดิต *
                        ตอนวงล้อกำลังหมุน ห้ามรีเฟรชเด็ดขาด ไม่สามารถขอคืนพ้อยต์ได้ในทุกกรณี *
                            <center>
                                <a class="btn bg-main w-100 text-white mb-2" id="random" style="border-radius: 50px;">หมุน</a>
                            </center>
                        </div>
                    </div>
                </div>
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                $('.spinner').easyWheel({
                    ...
                    sliceLineColor: '#000',
                    centerImage: '<?= htmlspecialchars($row['img']) ?>',
